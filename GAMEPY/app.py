...
class Cano:
    ...
    def definir_altura(self):
        ...
        self.pos_topo = (
            self.altura - self.CANO_TOPO.get_height()
        )
    ...
    def colidir(self, passaro):
        ...
        topo_mask = pygame.mask.from_surface(
            self.CANO_TOPO
        )

        base_mask = pygame.mask.from_surface(
            self.CANO_BASE
        )
    ...
    while rodando:
        ...
        if not game_over:
            ...
            for cano in canos:
                ...
                if (
                    cano.x + cano.CANO_TOPO.get_width()
                    < 0
                ):
            ...
            # Colisão com o chão
            if (
                passaro.y + passaro.imagem.get_height()
                >= chao.y
            ):
                game_over = True
